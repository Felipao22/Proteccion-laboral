          ...
          <main>
            ...
            <div className="services-paragraph">
              <ul className="column-ul">
                ...
                <li>
                  Capacitaciones en materia de Prevención de Accidentes de
                ...
                <li>
                  Mediciones protocolarizadas de Iluminación (Resolución S.R.T.
                  N° 84/2012).
                </li>
                <li>
                  Evaluaciones Ergonómicas protocolarizadas (Resolución S.R.T.
                  N° 886/2015).
                </li>
                ...
                <li>
                  Asesoramiento sobre gestión de siniestros y coberturas de
                  A.R.T.
                </li>
                <li>
                  Implementación y desarrollo de programas para la reducción de
                  la siniestralidad.
                </li>
                <li>
                ...
                <li>
                  Relevamientos direccionados sobre el control de
                  infraestructura y elementos de prevención.
                </li>
                <li>
                  {" "}
